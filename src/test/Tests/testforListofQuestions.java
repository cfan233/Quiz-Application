...
public class testforListofQuestions {
    ...
    @Test
    void testaddQuestion1(){
        Question q1 = new Question("What is the capital of Canada?", "Ottawa", 1);
        Question q2 = new Question("Which city is UBC at?", "Vancouver", 2);
        Question q3 = new Question("Who is the prime minister of Canada?", "Justin Trudeau", 3);
        Question q4 = new Question("Who owns Tesla?","Elon Musk", 1);

        loq.getListOfQuestions1().size();


        assertEquals(0, loq.getListOfQuestions1().size());
        loq.addQuestion(q1);
        assertEquals(q1, loq.getListOfQuestions1().get(0));
        ...
        loq.addQuestion(q4);
        loq.addQuestion(q1);
        assertEquals(q2, loq.getListOfQuestions1().get(1));
        assertEquals(q3, loq.getListOfQuestions1().get(2));
        assertEquals(q4, loq.getListOfQuestions1().get(3));
        assertEquals(q1, loq.getListOfQuestions1().get(4));
        assertEquals(5, loq.getListOfQuestions1().size());
    }
    ...
    @Test
    void testremoveQuestionstring1(){
        Question q1 = new Question("What is the capital of Canada?", "Ottawa", 1);
        Question q2 = new Question("Which city is UBC at?", "Vancouver", 2);
        Question q3 = new Question("Who is the prime minister of Canada?", "Justin Trudeau", 3);
        Question q4 = new Question("Who owns Tesla?","Elon Musk", 1);
